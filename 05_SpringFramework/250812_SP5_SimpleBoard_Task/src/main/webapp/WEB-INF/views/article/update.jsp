<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<tr>
		<th>제목</th>
		<td><input type="text" name="title" value="${articleDTO.title}" autofocus="autofocus" required="required"/></td>
	</tr>
	<tr>
		<th>이름</th>
		<td><input type="text" name="name" value="${articleDTO.name}" required="required"/></td>
	</tr>
	<tr>
		<th>비밀번호</th>
