...
<html>
  ...
  <body>
    ...
    <!--
        로그인 여부에 따라 게시물 작성 폼 또는 로그인 안내 메시지 표시:
        사용자가 로그인되어 있으면 (세션에 loginMember가 존재하면) 게시물 작성 폼을 보여줍니다.
        로그인되어 있지 않으면 로그인 필요 메시지와 로그인 페이지로 이동하는 링크를 보여줍니다.
    -->
    ...
    <c:if test="${empty sessionScope.loginMember}">
      <p>로그인이 필요한 서비스입니다.</p>
      <a href="/controller/member/login">로그인 페이지로 이동</a>
    </c:if>
  </body>
</html>